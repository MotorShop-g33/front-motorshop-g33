        ...
        <DivModal>
          ...
          <ModalContent>
            ...
            >
              ...
              <FormControl isRequired mt={4} isInvalid={Boolean(errors.brand)}>
              ...
              <FormControl isRequired mt={4} isInvalid={Boolean(errors.model)}>
                  ...
                  <FormControl mt={4} isInvalid={Boolean(errors.photos)}>
                    ...
                    <Input
                      ...
                      onChange={(event) => {
                        ...
                        setValue("photos", [...addPhotos, event.target.value]);
                      }}
                      className="input"
                      placeholder="https://image.com"
                    />
